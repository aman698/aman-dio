...
1108  02e3 81            	ret
1182                     ; 169 void wiz_send_data(uint8_t sn, uint8_t *wizdata, uint16_t len)
1182                     ; 170 {
1183                     	switch	.text
...
1191                     ; 171    uint16_t ptr = 0;
1193                     ; 172    uint32_t addrsel = 0;
1195                     ; 174    if(len == 0)  return;
1197  02e7 1e10          	ldw	x,(OFST+6,sp)
1198  02e9 2603          	jrne	L24
1199  02eb cc03b1        	jp	L04
1200  02ee               L24:
1203                     ; 175    ptr = getSn_TX_WR(sn);
...
1254                     ; 178    addrsel = ((uint32_t)ptr << 8) + (WIZCHIP_TXBUF_BLOCK(sn) << 3);
...
1284                     ; 180    WIZCHIP_WRITE_BUF(addrsel,wizdata, len);
...
1351  03b3 81            	ret
1425                     ; 186 void wiz_recv_data(uint8_t sn, uint8_t *wizdata, uint16_t len)
1425                     ; 187 {
1426                     	switch	.text
...
1434                     ; 188    uint16_t ptr = 0;
1436                     ; 189    uint32_t addrsel = 0;
1438                     ; 191    if(len == 0) return;
1440  03b7 1e10          	ldw	x,(OFST+6,sp)
1441  03b9 2603          	jrne	L25
1442  03bb cc0481        	jp	L05
1443  03be               L25:
1446                     ; 192    ptr = getSn_RX_RD(sn);
...
1497                     ; 195    addrsel = ((uint32_t)ptr << 8) + (WIZCHIP_RXBUF_BLOCK(sn) << 3);
...
1527                     ; 197    WIZCHIP_READ_BUF(addrsel, wizdata, len);
...
1594  0483 81            	ret
1648                     ; 204 void wiz_recv_ignore(uint8_t sn, uint16_t len)
1648                     ; 205 {
1649                     	switch	.text
...
1657                     ; 206    uint16_t ptr = 0;
1659                     ; 208    ptr = getSn_RX_RD(sn);
